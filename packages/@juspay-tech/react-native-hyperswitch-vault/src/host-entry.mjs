 ...
 *
 * AUDIENCE. The checkout SDK, never merchants. It renders the same provider and the same four
 ...
 * provider imported from the other.
 *
 * Deliberately absent: the ready-made `HyperswitchVaultForm` and `createCardForm`. The checkout SDK
 * composes fields itself and has never used them.
 */
